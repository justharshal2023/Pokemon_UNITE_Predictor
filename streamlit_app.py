...
# File uploader
    ...
    # Crop and store each Pokémon image with additional cropping
        ...
        # Store the image in the dictionary
            ...
            predicted_class[f'pokemon_{i + 1}'] = predict_image(pokemon_image)[0]
    ...
    # Plot the Pokémon images
        ...
        fig.tight_layout(pad=2.0, rect=[0, 0.03, 1, 0.95])  # Adjust the layout to accommodate the title and footer
